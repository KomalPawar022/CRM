...
export default function Quote() {
    ...
    const handleViewLeadClick = (Subject,stages,Total,DealName,Conatct,AcName,Owner) => {
      navigate(`/ViewQuote/${Subject}/${stages}/${Total}/${DealName}/${Conatct}/${AcName}/${Owner}`);
    };
 ...
 // Get the current page items
    const currentItems = QuoteData.slice(startIndex, endIndex);
  ...
  return (
    ...
    <div className="container-fluid">
        <div className="row justify-content-end mb-2 mt-2">
         ...
         <button className='btn btn-dark ms-2' onClick={()=>createLead()}><i class="fa-solid fa-plus me-2" ></i>Create Quote</button>
         <Dropdown>
    ...
    <div className="card mb-2">
      <div className="card-body">
        ...
        <tbody>
         {
           data.map((i,index)=>
           <tr key={index} onClick={()=>props.prop(i.Subject,i.stages,i.Total,i.DealName,i.Conatct,i.AcName,i.Owner)}>
             <td>{i.Subject}</td>
            <td>{i.stages}</td>
            <td>{i.Total}</td>                         
            <td>{i.DealName}</td>
    ...
    <div>
      ...
      <div className="row">
       ...
       <p className="card-text">
         <strong>Stage:</strong> {i.stages}
       </p>
       <p className="card-text">
         <strong>Total:</strong> {i.Total}
       </p>
       <p className="card-text">
         <strong>Deal:</strong> {i.DealName}
       </p>
       <p className="card-text">
         <strong>Contact:</strong> {i.Conatct}
       </p>
       <p className="card-text">
         <strong> Owner:</strong> {i.Owner}
       </p>
       <div className="text-center">
         <button className="btn btn-primary" onClick={()=>props.prop(i.Subject,i.stages,i.Total,i.DealName,i.Conatct,i.AcName,i.Owner)}>View Details</button>
       </div>
              ...
              <div style={Styles.card}>
                {stageData.map((i) => (
                  <div key={i.id} className="card bg-light mb-3 text-start border-top-primary">
                    <div onClick={() => props.prop(i.Subject,i.stages,i.Total,i.DealName,i.Conatct,i.AcName,i.Owner)}>
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          <strong>Account:</strong> {i.AcName}
                        </p>
