      ...
      <nav className="navbar navbar-expand-xl bg-dark">
        <div className="container-fluid">
          <a className="navbar-brand text-white fw-bold">
            {" "}
            <i className="fa fa-slack" aria-hidden="true"></i> CRM
          </a>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link to="/lead" className="nav-link text-white">
                  Lead
                </Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <Link to="/Deal" className="nav-link text-white">
                  Deal
                </Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <Link to="/Call" className="nav-link text-white">
                  Call
                </Link>
              </li>
              <li className="nav-item">
