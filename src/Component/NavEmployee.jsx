...
function NavEmployee({dept}) {
  ...
  return (
    <div>
         ...
         <div>
          <div style={{backgroundColor:"#ebe7e7",padding:"15px",width:"77vw",margin:"25px",textAlign:"center"}}>{dept}</div>
...
<Link to="/Organization/DepartMentDirectory/NewProfile">      <img  style={{height:"80px",width:"80px",position:"relative",left:"74px",top:"-37px"}} src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" alt="" /></Link> 
    ...
    <div style={{marginLeft:"62%",marginTop:"40px",position:"absolute"}}>
      <div style={{border:"1px solid black",width:"250px",height:"250px"}}>
      <Link to="/Organization/DepartMentDirectory/NewProfile">      <img  style={{height:"80px",width:"80px",position:"relative",left:"74px",top:"-37px"}} src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" alt="" /></Link> 
        <p style={{fontWeight:"bold",textAlign:"center"}}>S3 - Clarkson Walter</p>
    ...
    <br />
          ...
          </div></>:(dept=="MARKETING"?<>   <div style={{display:"flex",flexWrap:"wrap"}}>
